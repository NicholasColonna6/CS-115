...
#print(questify(['test1','test2', 'test3']))
#print(questifyAlt(['test1','test2', 'test3']))
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Exercise 2
...
#print(catenate(['test1','test2', 'test3']))
#print(catenateLoop(['test1','test2', 'test3']))        
...
#print(letterScore('q', scrabbleScores))
#print(letterScoreLoop('q', scrabbleScores))
...
def wordScoreLoop(S, scorelist):
    ...
    i = 0
    while i < len(S):
        score += letterScore(S[i], scorelist)
        i += 1
    return score
    
#print(wordScore("testing", scrabbleScores))    
#print(wordScoreLoop("testing", scrabbleScores))  
...
def wordsWithScoreLoop(dct, scores):
    ...
    result = []
    for word in dct:
        result += [[word, wordScore(word, scores)]]
    return result
